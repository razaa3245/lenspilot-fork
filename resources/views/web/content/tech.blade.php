<section id="technology" class="py-20 bg-gray-50 font-sans">
  <div class="max-w-6xl mx-auto flex flex-col lg:flex-row flex-wrap items-center justify-between gap-10 px-4">
    ...
    <div class="flex-1 min-w-[220px] max-w-md relative mx-auto mb-10 lg:mb-0 text-center">
      ...
      <img src="{{ asset('images/cuttingar.jpeg') }}" alt="Contact Lenses and Eyewear Technology Showcase"
...
<section id="use-cases"
  class="relative py-24 bg-gradient-to-b from-[#f8fafc] via-[#eef2ff] to-[#dbeafe] font-sans overflow-hidden">
  <!-- Background glow -->
  <div class="absolute inset-0 bg-[radial-gradient(circle_at_center,_rgba(59,130,246,0.15),_transparent_60%)] blur-3xl">
  </div>
  ...
  <div class="max-w-7xl mx-auto text-center relative z-10 px-6">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
      <!-- Card -->
      <div
        class="group bg-white/70 backdrop-blur-xl rounded-2xl border border-white/50 shadow-xl p-8 text-left transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:bg-white/90">
        <div
          class="bg-blue-100 w-14 h-14 flex items-center justify-center rounded-xl mb-5 group-hover:scale-110 transition-transform duration-300">
