  ...
  <aside x-data="{ open: false }" :class="open ? 'w-64' : 'w-20'"
    ...
    <div>
      ...
      <div x-show="open" class="mx-4 mt-6 bg-cyan-50 border border-cyan-200 rounded-2xl p-4 shadow-sm text-center">
        ...
        <p class="text-lg font-bold text-gray-800 mt-1">Enterprise <span class="text-sm text-gray-500"></span></p>
          ...
          <div
            ...
            <div class="divide-y divide-slate-200">
              <a href="/shopkeeper/catalog1"
                class="block w-full text-left py-3 text-cyan-600 hover:text-cyan-700 hover:bg-cyan-50 transition-all duration-300 font-medium text-sm">
