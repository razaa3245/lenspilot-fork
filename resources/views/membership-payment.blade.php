...
<body>
    <div class="checkout-wrapper">
        ...
        <form id="payment-form" action="{{ route('membership.payment') }}" method="POST">
            @csrf
            ...
            <div class="d-flex flex-column flex-md-row">
                ...
                <div class="flex-grow-1">
                    ...
                    <div class="mb-3 p-3 rounded" style="background:#f8f9fb; border:1px solid #eee;">
                        <p class="mb-1" style="font-size:0.88rem;"><strong>PROFESSIONAL PLAN</strong></p>
                        <p class="mb-1" style="font-size:0.88rem;"><strong>PRICE:</strong> Rs{{ number_format($planAmount,0) }}</p>
                        <p class="mb-1" style="font-size:0.88rem;"><strong>DURATION:</strong>6 Month</p>
                        <p class="mb-0" style="font-size:0.88rem;"><strong>Growing Businesses</strong></p>
                    </div>
